...
function getVisualCellText(vtable, col, row) {
  try {
    ...
    (function walk(node, depth) {
      ...
      if (node.type === 'text' && node.attribute && node.attribute.text !== undefined && node.attribute.text !== null) {
        var t = String(node.attribute.text).trim();
        if (t) texts.push(t);
      }
...
function getCellRenderInfo(col, row, detail) {
  ...
  var result = {
    ...
    text: (function () {
      ...
      var v = textNodes.map(function (n) { return n.text; });
